...
note right of MethodObject : 3, 4, 5) Se mueve el metodo a extraer al metodo\nde evaluacion del Method Object
note right of ClassWithMethodToExtract : 6) Reemplazo del metodo a extraer por\nla evaluacion del Method Object
#+END_SRC

#+RESULTS:
[[file:diagrams/extract_to_method_object_application_steps.png]]
...
se llama Command pattern \cite{gamma94_gof}, y es subclase de
~ParseNodeVisitor~. Veamos un ejemplo de uso de la misma:
...
automáticos que lo cubren. Además, se realizó una prueba automática, que busca
simular el uso habitual de un programador, en la cual:
